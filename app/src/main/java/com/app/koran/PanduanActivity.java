...
public class PanduanActivity extends AppCompatActivity {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        root_view = inflater.inflate(R.layout.fragment_news, null);
//        parent_view = getActivity().findViewById(R.id.main_content);
        ...
        mAdapter = new AdapterPostList(getApplicationContext(), recyclerView, new ArrayList<Post>());
        ...
        mAdapter.setOnItemClickListener(new AdapterPostList.OnItemClickListener() {
            ...
            public void onItemClick(View v, Post obj, int position) {
                ActivityPostDetails.navigate((ActivityMain) getApplicationContext(), v.findViewById(R.id.image), obj);
            }
        });
        ...
        Tools.requestInfoApi(getApplicationContext());
